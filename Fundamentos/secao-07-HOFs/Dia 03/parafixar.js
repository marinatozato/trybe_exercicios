...
const sumNumbers = numbers.reduce((acc, curr) => {
  console.log(`O valor de acc é: ${acc} e o de curr é: ${curr}`);
  return acc + curr
}, 0);
...
const sumEvenNumbers = (array) => array.reduce(sum, 0);
...
const { nome, materias: { name: materia, nota: valorDaNota}} = estudantes;
